...
// export default Task;
// const project = new Project("project 1" , "this is project 1" , "2000/12/12") ; 
// const task = new Task("task 1 " , 1 ,"2000/12/12" , false ) ; 
//projectList.push(project) ; 

const opendFormEdit =(index)=>{
        const curProject =  projectList[index];
        const elmentAddtask =  document.getElementById("addtask") ; 
...
const renderListTask = (project)=>{
    ...
    if(project === undefined){
        ...
        //     elmentContainerTask.style.textDecoration =""
        // }
